...
def get_events(filedir, fpra, frame_threshold_count, heading_std_threshold=0.4, speed_fraction=0.66, framerate=0, write=False,
               debugprints=False):
    ...
    for filename in files:
        ...
        # Get the framerate. If the framerate is in the filename, use it, otherwise raise and error to insert a manual framerate.
        ...
        for trajectory in x_pos:
            ...
            for k in range(5, len(rolled_speed) - 2):
                ...
                if not directions_swap and not changing_direction and not slowing:
                    ...
                    elif event_slowing or event_changing_direction or prolonged_changing_direction:
                        result = 'reverse'
                        if debugprints:
